    ...
    <div className="register-page">
      <div className="register-container">
        <div className="register-header">
          <h1>Join API Finder</h1>
          <p>Sign up to unlock advanced features and save your favorite APIs</p>
        </div>
        ...
        <div className="register-form">
          <div className="social-buttons">
            ...
            <Link to="/register-email" className="email-register-link">
              Register with Email
            </Link>
          </div>

          <div className="register-benefits">
            <h3>Why join API Finder?</h3>
            <ul>
              <li>
